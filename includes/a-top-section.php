...
if ( isset( $_SESSION[ "u_type" ] ) ) {
	if ( $_SESSION[ "u_type" ] != 0 && $_SESSION[ "u_type" ] != 3 )
...
if ( isset( $_POST[ "logout" ] ) ) {
	...
	$conn->query( "UPDATE login SET access_token=NULL WHERE u_id='" . $u_id . "' AND u_type=0" );
	session_unset();
	session_destroy();
	header( "Location: /" );
	die();
	...
	<body>
		...
		<div class="header">
			<div class="header-logo">
				<img src="<?php echo $school_logo; ?>" widtd="100" height="100" style="width: 9vw; height: 9vw;" title="<?php echo $school_name ?>" alt="School Logo"/>
			</div>
