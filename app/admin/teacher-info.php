...
$data = $conn->query( "SELECT * FROM teacher t WHERE t.t_id='" . $t_id . "' LIMIT 1" )->fetch_assoc();
?>
...
<div class="rightcolumn">
	<div class="card" style="padding: 25px 100px 100px;">
		...
		<a href="edit-teacher-info?id=<?php echo $data["t_id"]; ?>"><input type="submit" value="Edit Details"></a><br><br>
		<table>
			<tr>
			...
			<tr>
				...
				<td class="tdata">
					<?php if ($data["married"]) echo 'Married'; else echo 'Single'; ?>
				</td>
			</tr>
			<tr>
